  ...
  <view class="content">
    ...
    <view>
      <view class="login-m">
		...
		<view class="goforgetpwd color-9 fsz24" @click="goForgetpwd()">
			忘记密码？
		</view>
      </view>
      <view class="login-b">
		...
		<view class="color-9 fsz24 agreement">
			登录即代表你同意 <text @click="goAgreement()" class="color-o">用户协议</text> 和 <text @click="goPrivacy()" class="color-o">隐私政策</text>
		</view>

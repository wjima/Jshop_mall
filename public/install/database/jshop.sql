...
CREATE TABLE `jshop_goods_type_spec` (
  ...
  PRIMARY KEY (`id`),
  KEY `sort` (`sort`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='商品类型属性表';
...
CREATE TABLE `jshop_goods_type_spec_value` (
  ...
  KEY `spec_id` (`spec_id`),
  KEY `sort` (`sort`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='商品类型属性值表';
...
INSERT INTO `jshop_hooks` VALUES ('13', 'orderpayed', '订单付款', '1', '', '1542368994', '1542368994');
...
-- ----------------------------
INSERT INTO `jshop_images` VALUES ('2a3a3c96239408d0b27c4752b0b83487', '80C6915901A29ECCF7EA68E9393CF76C.png', 'http://image.jihainet.com/static/uploads/a7/20/c9/5be5900ed7051.png', '/Applications/MAMP/htdocs/b2c_standard//public/static/uploads/a7/20/c9/5be5900ed7051.png', '', '1541771279', null);
...
CREATE TABLE `jshop_logistics` (
  ...
  KEY `sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=1101 DEFAULT CHARSET=utf8mb4 COMMENT='物流公司表';
...
CREATE TABLE `jshop_operation_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COMMENT='后台操作记录表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='促销条件表';
...
CREATE TABLE `jshop_promotion_result` (
  ...
  PRIMARY KEY (`id`),
  KEY `promotion_id` (`promotion_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='促销结果表';
...
-- ----------------------------
INSERT INTO `jshop_user_log` VALUES ('1', '13', '2', '1542367331', '[]', '127.0.0.1');
INSERT INTO `jshop_user_log` VALUES ('2', '13', '1', '1542367389', '[]', '127.0.0.1');

...
class Api extends \app\common\controller\Api
{
    ...
    public function index()
    {
        ...
        $data["daishiporder"] = $orderMode->field("order_id")->where("pay_status", "eq", 2)->where("ship_status", "eq", 1)->count();
        $data["daipayorder"] = $orderMode->field("order_id")->where("pay_status", "eq", 1)->count();
        //会员数量
        $UserModel = new User();

...
﻿3. 商品： 
	...
	4. 商品列表sql注入漏洞修复
	5. 商品详情加库存信息
	6. 关闭规格时，商品中自定义规格值置为空
	7. 商品类型bug修复
	8. 商品编辑
	9. 扩展分类没有选择的不保存
﻿4. 订单：
	1. 计划任务取消订单把拼团，秒杀，团购也加进去了
	2. 订单赠品评论优化，赠品就不让评价了
	3. 修复订单定时签收
	4. 订单编辑订单详情显示下单人
	5. 订单促销的时候，订单表上的商品金额优化
	6. 优化修改订单价格和邮费
	7. 防止重复创建订单
﻿5. 促销：
	1. 促销重构
...
﻿6. 团购：
	...
	5. 限购数量优化
	6. 团购秒杀促销结果屏蔽
	7. 团购秒杀详情页销量，海报价格问题修复
	8. 修复编辑团购秒杀删除条件后token验证出错问题
	9. 团购秒杀都增加上下架过滤
	10. 团购首页列表价格修复
	11. 优化团购秒杀切换规格的划线价
﻿7. 秒杀：团购秒杀优化sql
...
﻿9. 海报：
	...
	4. 首页分享海报制作
﻿10. 优惠券：
	1. 修复优惠券问题删除优惠券数据的时候把用户未使用的优惠券一并删掉
﻿11. 其他：
	1. 微信小程序直播
	2. 绑定手机号
	3. 样式优化
	...
	5. 修改导入导出日志内容类型
	6. 前端个人信息添加用户名手机号
	7. 优化后台token验证机制，默认开启防CSRF攻击以及防止重复提交表单，如果不想开启，config\app.php里面validate_token改为false即可

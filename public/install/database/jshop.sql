...
-- ----------------------------
BEGIN;
INSERT INTO `jshop_addons` VALUES (2, 'hecong', '合从在线客服插件', '合从在线客服，申请地址https://aihecong.com/', 1, '{\"appid\":\"\",\"appkey\":\"\"}', 'mark', '0.1', 1538029352, 1538029352);
...
INSERT INTO `jshop_addons` VALUES (5, 'test', '插件测试', 'thinkph5插件测试', 1, '{\"display\":\"1\"}', 'byron sampson', '0.1', 1540104045, 1540104045);
...
CREATE TABLE `jshop_advert_position` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='广告位置表';
...
INSERT INTO `jshop_area` VALUES (0, 500200, 3, '静海县', 301600, 100);
INSERT INTO `jshop_area` VALUES (0, 330100, 3, '富阳市', 311400, 100);
INSERT INTO `jshop_area` VALUES (0, 410100, 3, '郑东新区', 0, 100);
INSERT INTO `jshop_area` VALUES (0, 440100, 3, '萝岗区', 510100, 100);
COMMIT;
...
CREATE TABLE `jshop_bill_delivery_items` (
  ...
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COMMENT='发货单详情表';
...
CREATE TABLE `jshop_brand` (
  ...
  KEY `sort` (`sort`),
  KEY `isdel` (`isdel`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COMMENT='品牌表';
...
CREATE TABLE `jshop_cart` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COMMENT='购物车表（每个用户最多加100条信息）';
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COMMENT='商品表';
...
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8mb4 COMMENT='商品分类';
...
CREATE TABLE `jshop_goods_type_spec_value` (
  ...
  KEY `spec_id` (`spec_id`),
  KEY `sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COMMENT='商品类型属性值表';
...
CREATE TABLE `jshop_label` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='标签表';
...
CREATE TABLE `jshop_logistics` (
  ...
  KEY `sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=1100 DEFAULT CHARSET=utf8mb4 COMMENT='物流公司表';
...
CREATE TABLE `jshop_manage_role` (
  ...
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COMMENT='总后台角色表';
...
CREATE TABLE `jshop_message` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COMMENT='站内信';
...
CREATE TABLE `jshop_message_center` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='消息中心表';
...
CREATE TABLE `jshop_operation` (
  ...
  KEY `sort` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=527 DEFAULT CHARSET=utf8mb4 COMMENT='权限表';
...
INSERT INTO `jshop_operation` VALUES (416, 2, '管理员管理', 'Manage', 'c', 2, 3, 100);
...
CREATE TABLE `jshop_operation_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='后台操作记录表';
...
CREATE TABLE `jshop_order_items` (
  ...
  `utime` bigint(12) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COMMENT='订单明细表';
...
CREATE TABLE `jshop_products` (
  ...
  KEY `goods_id` (`goods_id`),
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4 COMMENT='货品表';
...
CREATE TABLE `jshop_promotion` (
  ...
  KEY `status` (`status`),
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='促销表';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='促销条件表';
...
CREATE TABLE `jshop_promotion_result` (
  ...
  PRIMARY KEY (`id`),
  KEY `promotion_id` (`promotion_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='促销结果表';
...
CREATE TABLE `jshop_ship` (
  ...
  KEY `sort` (`sort`),
  KEY `sort_2` (`sort`)
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8mb4 COMMENT='配送方式表';
...
CREATE TABLE `jshop_template` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='模板列表';
...
CREATE TABLE `jshop_template_order` (
  ...
  `utime` bigint(12) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='模板订购记录表';
...
CREATE TABLE `jshop_user_point_log` (
  ...
  `ctime` bigint(12) unsigned DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='用户积分记录表';
...
CREATE TABLE `jshop_weixin_author` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='获取授权方的帐号基本信息表';
...
CREATE TABLE `jshop_weixin_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COMMENT='微信公众号菜单表';
...
CREATE TABLE `jshop_weixin_message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COMMENT='微信消息表';

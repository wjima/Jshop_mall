...
class alipay implements Payment
{
    ...
    private function verify($data, $sign, $signType = 'RSA') {
        ...
        $res = "-----BEGIN PUBLIC KEY-----\n" .
            "".//wordwrap($pubKey, 64, "\n", true) .
            "\n-----END PUBLIC KEY-----";

...
CREATE TABLE IF NOT EXISTS `jshop_addons` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='插件表' AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `jshop_advertisement` (
  ...
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='广告表' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `jshop_advert_position` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='广告位置表' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `jshop_bill_delivery_items` (
  ...
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='发货单详情表' AUTO_INCREMENT=16 ;
...
CREATE TABLE IF NOT EXISTS `jshop_brand` (
  ...
  KEY `sort` (`sort`),
  KEY `isdel` (`isdel`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='品牌表' AUTO_INCREMENT=18 ;
...
CREATE TABLE IF NOT EXISTS `jshop_cart` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='购物车表（每个用户最多加100条信息）' AUTO_INCREMENT=40 ;
...
CREATE TABLE IF NOT EXISTS `jshop_clerk` (
  ...
  `isdel` bigint(12) unsigned DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='店铺店员关联表' AUTO_INCREMENT=5 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='商品表' AUTO_INCREMENT=17 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='商品分类' AUTO_INCREMENT=34 ;
...
CREATE TABLE IF NOT EXISTS `jshop_goods_params` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='商品参数表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `jshop_goods_type` (
  ...
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='商品类型' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `jshop_goods_type_spec` (
  ...
  PRIMARY KEY (`id`),
  KEY `sort` (`sort`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='商品类型属性表' AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `jshop_goods_type_spec_value` (
  ...
  KEY `spec_id` (`spec_id`),
  KEY `sort` (`sort`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='商品类型属性值表' AUTO_INCREMENT=32 ;
...
(14, 'orderpayed', '订单支付', 1, 'test', 1542349293, 1542349507);
...
CREATE TABLE IF NOT EXISTS `jshop_ietask` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='导入导出任务表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `jshop_jobs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='队列表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `jshop_label` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='标签表' AUTO_INCREMENT=5 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='管理员表' AUTO_INCREMENT=19 ;
...
CREATE TABLE IF NOT EXISTS `jshop_manage_role` (
  ...
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='总后台角色表' AUTO_INCREMENT=10 ;
...
CREATE TABLE IF NOT EXISTS `jshop_message` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='站内信' AUTO_INCREMENT=40 ;
...
CREATE TABLE IF NOT EXISTS `jshop_message_center` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='消息中心表' AUTO_INCREMENT=6 ;
...
CREATE TABLE IF NOT EXISTS `jshop_notice` (
  ...
  KEY `isdel` (`isdel`),
  KEY `sort` (`sort`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='公告表' AUTO_INCREMENT=1 ;
...
(245, 244, '平台设置', 'index', 'a', 244, 1, 100),
...
CREATE TABLE IF NOT EXISTS `jshop_operation_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='后台操作记录表' AUTO_INCREMENT=11 ;
...
CREATE TABLE IF NOT EXISTS `jshop_order_items` (
  ...
  `utime` bigint(12) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='订单明细表' AUTO_INCREMENT=27 ;
...
CREATE TABLE IF NOT EXISTS `jshop_payments` (
  ...
  KEY `status` (`status`),
  KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='支付方式表' AUTO_INCREMENT=5 ;
...
CREATE TABLE IF NOT EXISTS `jshop_products` (
  ...
  KEY `goods_id` (`goods_id`),
  KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='货品表' AUTO_INCREMENT=57 ;
...
CREATE TABLE IF NOT EXISTS `jshop_promotion` (
  ...
  KEY `status` (`status`),
  KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='促销表' AUTO_INCREMENT=2 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='促销条件表' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `jshop_promotion_result` (
  ...
  PRIMARY KEY (`id`),
  KEY `promotion_id` (`promotion_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='促销结果表' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `jshop_ship` (
  ...
  KEY `sort` (`sort`),
  KEY `sort_2` (`sort`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='配送方式表' AUTO_INCREMENT=10002 ;
...
CREATE TABLE IF NOT EXISTS `jshop_template` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='模板列表' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `jshop_template_order` (
  ...
  `utime` bigint(12) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='模板订购记录表' AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `jshop_user` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='用户表' AUTO_INCREMENT=33 ;
...
CREATE TABLE IF NOT EXISTS `jshop_user_point_log` (
  ...
  `ctime` bigint(12) unsigned DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='用户积分记录表' AUTO_INCREMENT=14 ;
...
CREATE TABLE IF NOT EXISTS `jshop_weixin_author` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='获取授权方的帐号基本信息表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `jshop_weixin_publish` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='小程序发布审核表' AUTO_INCREMENT=1 ;
